        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Doğal taş işçiliğinde kalite ve güvenin adresi. 20 yılı aşkın
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-sm mb-4">Hızlı Bağlantılar</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-sm mb-4">Hizmetlerimiz</h3>
            <ul className="space-y-2.5">
          ...
          <div>
            ...
            <div className="space-y-2.5 text-sm">
              <p className="text-white/50">
                Aşık Veysel, 5733/3. Sk. No: 36/A
              </p>
              <p className="text-white/50">35130 Karabağlar/İzmir, Türkiye</p>
              <a
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-center text-white/40 text-sm">
            &copy; {new Date().getFullYear()} Derintaş Mermer & Granit. Tüm
            hakları saklıdır.
          </p>
        </div>
      </div>
