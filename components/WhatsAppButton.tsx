...
const PHONE_NUMBER = "905330306237"; // Numarayı güncelleyin
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      {tooltip && (
        <div className="hidden sm:block bg-white rounded-lg shadow-lg px-4 py-2.5 text-sm font-medium text-gray-700 animate-fade-in">
          Bize yazın!
